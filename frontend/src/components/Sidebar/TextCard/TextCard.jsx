    ...
    return (
        <div className={s.textCard}>
            <svg width="25px" height="25px" className={s.delete} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" onClick={()=>deleteCard(text.id)}>
                ...
                <path stroke="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7h-2M4 7h2m0 0h12M6 7v11a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7m-9-.5v0A2.5 2.5 0 0 1 11.5 4h1A2.5 2.5 0 0 1 15 6.5v0" />
            </svg>
